...
var _certification = require('./../../db/handler/certification');
...
var CertificationController = function (_Response) {
  _inherits(CertificationController, _Response);

  function CertificationController() {
    _classCallCheck(this, CertificationController);

    return _possibleConstructorReturn(this, (CertificationController.__proto__ || Object.getPrototypeOf(CertificationController)).apply(this, arguments));
  }

  _createClass(CertificationController, [{
    key: 'index',
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                dbHandler = new _certification2.default();
