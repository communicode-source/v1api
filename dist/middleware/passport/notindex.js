...
var LocalStrategy = require('passport-local').Strategy; // Allows for custom local validation.
var auth = require('./../../config/auth.json'); // Super secret sauces.
var User = require('./../../db/model/user'); // User model.
var t = require('./../../db/handler/user');
var UserModel = new t();
...
module.exports = function (passport) {
  ...
  passport.use(new FacebookStrategy({ // Using the facebook passport startegy to lgo people in.
    ...
    // Annoying thing that took me forever to figure out how to use.
...
//# sourceMappingURL=notindex.js.map